...
(`games-researcher.md`, `game-monetizer.md`, `my-game-preference.md`, `unity-3d.md`) hold
the detail; pull whichever the question needs. When I think out loud here, use this to push
...
- **Game concept — NOT YET LOCKED, but leading candidate:**
  ...
  > and a **visibly-growing board** for an intrinsic "pull to reach more." A small
...
## The four "brains" behind this project

Back in the repo I run four custom skills. Each has a companion **reference file** in this
...
2. **`game-monetizer.md`** — F2P monetization & economy design for a solo iOS dev. Use
...
4. **`unity-3d.md`** — Unity + iOS technical reality for a solo, agentic, hyper/hybrid-
...
The best concept sits at the **intersection of all four**: marketable (researcher), pays
(monetizer), something I'll love (preference), buildable solo (unity).
...
- This `CHAT/` folder is the **source I sync into the Claude.ai project**: `INSTRUCTIONS.md`
  goes in the project's **custom instructions** (or knowledge); the four reference files go
  in the project's **knowledge**.
